...
swoop_enemy_wait:
    ...
    and 15
    ret nz
    kcall(FAST_RANDOM)             ; Choose pattern (0 - 3)
    and 0b1100
    kld((smc_hl_storage + 1), hl)
    ld hl,swoop_data
    add a, l \ ld l, a \ jr nc, $+3 \ inc h ;HL -> pattern data
    kld(de, misc_flags)           ;DE -> flags of which patterns used
    ld a,(de)
